...
describe('Customer e2e test', () => {
    ...
    it('should load Customers', async () => {
        ...
        expect(await customerComponentsPage.getTitle()).to.eq('backofficeApp.customerCustomer.home.title');
    });
    ...
    it('should load create Customer page', async () => {
        ...
        expect(await customerUpdatePage.getPageTitle()).to.eq('backofficeApp.customerCustomer.home.createOrEditLabel');
    ...
    it('should delete last Customer', async () => {
        ...
        expect(await customerDeleteDialog.getDialogTitle()).to.eq('backofficeApp.customerCustomer.delete.question');
