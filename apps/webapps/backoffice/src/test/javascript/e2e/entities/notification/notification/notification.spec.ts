...
describe('Notification e2e test', () => {
    ...
    it('should load Notifications', async () => {
        ...
        expect(await notificationComponentsPage.getTitle()).to.eq('backofficeApp.notificationNotification.home.title');
    });
    ...
    it('should load create Notification page', async () => {
        ...
        expect(await notificationUpdatePage.getPageTitle()).to.eq('backofficeApp.notificationNotification.home.createOrEditLabel');
    ...
    it('should delete last Notification', async () => {
        ...
        expect(await notificationDeleteDialog.getDialogTitle()).to.eq('backofficeApp.notificationNotification.delete.question');
