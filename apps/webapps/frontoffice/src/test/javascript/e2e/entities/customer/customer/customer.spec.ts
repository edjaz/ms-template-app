...
describe('Customer e2e test', () => {
    ...
    it('should load Customers', async () => {
        ...
        expect(await customerComponentsPage.getTitle()).to.eq('frontofficeApp.customerCustomer.home.title');
    });
    ...
    it('should load create Customer page', async () => {
        ...
        expect(await customerUpdatePage.getPageTitle()).to.eq('frontofficeApp.customerCustomer.home.createOrEditLabel');
    ...
    it('should create and save Customers', async () => {
        ...
        await promise.all([
            ...
            customerUpdatePage.setUserIdInput('5')
        ]);
        ...
        expect(await customerUpdatePage.getUserIdInput()).to.eq('5');
    ...
    it('should delete last Customer', async () => {
        ...
        expect(await customerDeleteDialog.getDialogTitle()).to.eq('frontofficeApp.customerCustomer.delete.question');
