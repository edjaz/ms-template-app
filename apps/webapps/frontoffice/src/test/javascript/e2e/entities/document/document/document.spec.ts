...
describe('Document e2e test', () => {
    ...
    it('should load Documents', async () => {
        ...
        expect(await documentComponentsPage.getTitle()).to.eq('frontofficeApp.documentDocument.home.title');
    });
    ...
    it('should load create Document page', async () => {
        ...
        expect(await documentUpdatePage.getPageTitle()).to.eq('frontofficeApp.documentDocument.home.createOrEditLabel');
    ...
    it('should delete last Document', async () => {
        ...
        expect(await documentDeleteDialog.getDialogTitle()).to.eq('frontofficeApp.documentDocument.delete.question');
