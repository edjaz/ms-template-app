...
describe('DocumentEntity e2e test', () => {
    ...
    it('should load DocumentEntities', async () => {
        ...
        expect(await documentEntityComponentsPage.getTitle()).to.eq('frontofficeApp.documentDocumentEntity.home.title');
    });
    ...
    it('should load create DocumentEntity page', async () => {
        ...
        expect(await documentEntityUpdatePage.getPageTitle()).to.eq('frontofficeApp.documentDocumentEntity.home.createOrEditLabel');
    ...
    it('should delete last DocumentEntity', async () => {
        ...
        expect(await documentEntityDeleteDialog.getDialogTitle()).to.eq('frontofficeApp.documentDocumentEntity.delete.question');
