...
import { AppHealthCheckComponent } from 'app/admin/health/health.component';
import { AppHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('AppHealthCheckComponent', () => {
        let comp: AppHealthCheckComponent;
        let fixture: ComponentFixture<AppHealthCheckComponent>;
        let service: AppHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [FrontofficeTestModule],
                declarations: [AppHealthCheckComponent]
            })
                .overrideTemplate(AppHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AppHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(AppHealthService);
        });
